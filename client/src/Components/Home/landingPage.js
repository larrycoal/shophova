...
import delivery from "../../images/clipart/deliveryTwo.png";
const LandingPage = () => {
    ...
    <div className="landing_wrapper">
      <section className="aboutText">
        <div>
          ...
          <p>
            lorem ipsum doloret orem ipsum doloret orem ipsum doloret lorem
            ipsum doloret orem ipsum doloret orem ipsum doloret
          </p>
        </div>
        <div></div>
      </section>
      ...
      <section className="pagination">
        ...
        <span
          ...
          className={slide.current === 0 ? "active" : null}
        ></span>
        <span
          onClick={() => changeSlide(1)}
          className={slide.current === 1 ? "active" : null}
        ></span>
        <span
          onClick={() => changeSlide(2)}
          className={slide.current === 2 ? "active" : null}
        ></span>
      </section>
    </div>
  );
